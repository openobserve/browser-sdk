...
| -------------------------------------------------------- | -------------------------------------------------------- |
| `datadoghq-browser-agent.com/us1/v6/openobserve-rum.js`      | `datadoghq-browser-agent.com/us1/v7/openobserve-rum.js`      |
| `datadoghq-browser-agent.com/us1/v6/openobserve-logs.js`     | `datadoghq-browser-agent.com/us1/v7/openobserve-logs.js`     |
| `datadoghq-browser-agent.com/us1/v6/openobserve-rum-slim.js` | `datadoghq-browser-agent.com/us1/v7/openobserve-rum-slim.js` |

Replace `us1` with your site: `eu1`, `us3`, `us5`, `ap1`, `ap2`. For US1-FED, the pattern is flat: `openobserve-rum-v7.js` (no site prefix).
...
```
"@openobserve/browser-rum": "^7.0.0"
"@openobserve/browser-logs": "^7.0.0"
"@openobserve/browser-rum-slim": "^7.0.0"
```

Then run your package manager (`npm install`, `yarn install`, etc.) and rebuild.

Also upgrade framework integrations to v7: `@openobserve/browser-rum-react`, `@openobserve/browser-rum-angular`, `@openobserve/browser-rum-vue`, `@openobserve/browser-rum-nextjs`.

Search: `grep -r "@openobserve/browser-" package.json`
...
```html
<script src="https://www.datadoghq-browser-agent.com/us1/v7/openobserve-rum.js" crossorigin="anonymous"></script>
```
...
script.src = 'https://www.datadoghq-browser-agent.com/us1/v7/openobserve-rum.js'
```
...
The `strategy` field has been removed from the plugin API. If you use `@openobserve/browser-rum-react` or other plugin integrations, upgrade them to v7.
...
- [ ] No `_oo_s` cookie remaining after first page load (should be `_oo_s_v2`)
