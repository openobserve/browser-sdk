import type { Context, FlushEvent, Observable, Telemetry } from '@openobserve/browser-core'
import { ONE_SECOND, addTelemetryMetrics, setInterval, TelemetryMetrics } from '@openobserve/browser-core'
