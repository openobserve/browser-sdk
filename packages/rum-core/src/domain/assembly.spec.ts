import type { ClocksState, RelativeTime, TimeStamp } from '@openobserve/browser-core'
import { ErrorSource, HookNames, ONE_MINUTE, display, startGlobalContext } from '@openobserve/browser-core'
