import { round, ONE_SECOND, noop, elapsed } from '@openobserve/browser-core'
import type { Duration, RelativeTime, WeakRef, WeakRefConstructor } from '@openobserve/browser-core'
