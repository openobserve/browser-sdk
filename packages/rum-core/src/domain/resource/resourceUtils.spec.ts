import { type Duration, type RelativeTime, type ServerDuration } from '@openobserve/browser-core'
import { ExperimentalFeature } from '@openobserve/browser-core'
import { mockExperimentalFeatures } from '@openobserve/browser-core/test'
