# `@openobserve/browser-core` package

`@openobserve/browser-core` is primarily consumed by other `@openobserve/browser-*` packages within this
...
When migrating code from `@openobserve/browser-core` to `@openobserve/js-core`, do **not** keep a
