...
export interface PublicApi {
  ...
  /**
   * For CDN async setup: Early RUM API calls must be wrapped in the `window.O2_RUM.onReady()` callback. This ensures the code only gets executed once the SDK is properly loaded.
   *
