...
Create a client-side Nuxt plugin such as `plugins/openobserve-rum.client.ts` and initialize the Datadog RUM SDK with `nuxtRumPlugin`:
...
import { addNuxtError } from '@openobserve/browser-rum-nuxt'
...
[2]: https://www.npmjs.com/package/@openobserve/browser-rum-nuxt
