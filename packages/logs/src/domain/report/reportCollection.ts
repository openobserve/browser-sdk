import type { Context, ClocksState } from '@openobserve/browser-core'
import { timeStampNow, ErrorSource, getFileFromStackTraceString, initReportObservable } from '@openobserve/browser-core'
