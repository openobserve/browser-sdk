import { ErrorHandling, ErrorSource, noop } from '@openobserve/browser-core'
import type { MockReportingObserver } from '@openobserve/browser-core/test'
import { mockReportingObserver } from '@openobserve/browser-core/test'
