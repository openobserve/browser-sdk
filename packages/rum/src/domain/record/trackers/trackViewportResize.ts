import { throttle, DOM_EVENT, addEventListeners, timeStampNow, noop } from '@openobserve/browser-core'
import type { RumConfiguration, ViewportDimension } from '@openobserve/browser-rum-core'
