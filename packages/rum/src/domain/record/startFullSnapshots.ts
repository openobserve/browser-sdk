import { LifeCycleEventType, getScrollX, getScrollY, getViewportDimension } from '@openobserve/browser-rum-core'
import type { RumConfiguration, LifeCycle } from '@openobserve/browser-rum-core'
