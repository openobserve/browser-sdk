import type { RumConfiguration, RumSessionManager, ViewHistory, RumSession } from '@openobserve/browser-rum-core'
import { getSessionReplayUrl, SessionReplayState } from '@openobserve/browser-rum-core'
