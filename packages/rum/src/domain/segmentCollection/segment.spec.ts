import type { DeflateEncoder, TimeStamp, Uint8ArrayBuffer } from '@openobserve/browser-core'
import { noop, setDebugMode, DeflateEncoderStreamId } from '@openobserve/browser-core'
