...
import { vuePlugin } from '@openobserve/browser-rum-vue'
...
Replace Vue Router's `createRouter` with the one from `@openobserve/browser-rum-vue/vue-router-v4`:
...
[2]: https://www.npmjs.com/package/@openobserve/browser-rum-vue
