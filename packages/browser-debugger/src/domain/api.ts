import type { Batch, Context, ContextValue } from '@openobserve/browser-core'
import { timeStampNow } from '@openobserve/js-core/time'
import { buildTag, generateUUID, globalObject, mergeArrays } from '@openobserve/browser-core'
