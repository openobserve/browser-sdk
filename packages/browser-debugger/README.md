...
To start collecting data, add [`@openobserve/browser-debugger`][2] to your `package.json` file, then initialize it with:
...
[2]: https://www.npmjs.com/package/@openobserve/browser-debugger
