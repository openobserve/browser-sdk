import type { Duration, ServerDuration, RelativeTime } from '@openobserve/js-core/time'
import { addExperimentalFeatures, ExperimentalFeature } from '@openobserve/browser-core'
