  ...
  describe('with allowlist and enablePrivacyForActionName is true', () => {
    ...
    it('preserves privacy level of the element when node privacy level is mask-unless-allowlisted', () => {
      const testCases = [
        {
          html: `
           <div data-o2-privacy="mask-unless-allowlisted" target>
            <span>foo</span>
            <div data-o2-privacy="mask">
              <span>bar</span>
              <div data-o2-privacy="allow">
                <span>baz</span>
              </div>
            </div>
          </div>
        ...
        {
          html: `
          <div data-o2-privacy="mask" target>
            <span>foo</span>
            <div data-o2-privacy="mask-unless-allowlisted">
              <span>bar</span>
              <div data-o2-privacy="allow">
                <span>baz</span>
              </div>
        ...
        {
          html: `
          <div data-o2-privacy="allow" target>
            <span>foo</span>
            <div data-o2-privacy="mask-unless-allowlisted">
              <span>bar</span>
              <div data-o2-privacy="allow">
        ...
        {
          html: `
          <div data-o2-privacy="mask-unless-allowlisted" alt="bar" target>
            <span>bar</span>
          </div>
          `,
          defaultPrivacyLevel: NodePrivacyLevel.MASK_UNLESS_ALLOWLISTED,
        ...
        {
          html: `
          <div data-o2-privacy="mask-unless-allowlisted" alt="foo" target>
            <span>bar</span>
          </div>
          `,
          defaultPrivacyLevel: NodePrivacyLevel.MASK_UNLESS_ALLOWLISTED,
    ...
    describe('with html tag privacy override when privacyEnabledActionName is true', () => {
      ...
      it('inherit privacy level and remove only the masked child', () => {
        expect(
          getActionNameFromElement(
            appendElement(`
              <div class="o2-privacy-allow" target>
                bar secret
                <div>
                  foo 
                  <div class="o2-privacy-mask">
                    <span>secret</span>
                  </div>
                </div>
              </div>
