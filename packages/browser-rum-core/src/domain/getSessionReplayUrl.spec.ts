...
describe('getDatadogSiteUrl', () => {
  const parameters: Array<[string, string | undefined, string]> = [
    ['datadoghq.com', undefined, 'api.openobserve.ai'],
    ...
    [
      {
        ...
        session: { id: 'session-id-1' } as SessionContext,
    ...
    [
      {
        ...
        session: { id: 'session-id-2' } as SessionContext,
    ...
    [
      {
        ...
        session: { id: 'session-id-3' } as SessionContext,
