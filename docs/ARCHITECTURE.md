...
The [monorepo](https://github.com/openobserve/browser-sdk) contains several packages:

```mermaid
graph TD
  core["@openobserve/browser-core\n(shared utilities)"]
  rum-core["@openobserve/browser-rum-core\n(core RUM)"]
  rum["@openobserve/browser-rum\n(full RUM)"]
  rum-slim["@openobserve/browser-rum-slim\n(lightweight RUM)"]
  rum-react["@openobserve/browser-rum-react\n(React integration)"]
  logs["@openobserve/browser-logs"]
  worker["@openobserve/browser-worker"]
...
### startRum [[code](https://github.com/openobserve/browser-sdk/blob/32ffe4bb7e50a37a43794773bbbc57aabb373468/packages/rum-core/src/boot/startRum.ts)]

Called at SDK initialization. Starts all event data collection.

### collection [[code](https://github.com/openobserve/browser-sdk/blob/32ffe4bb7e50a37a43794773bbbc57aabb373468/packages/rum-core/src/domain/rumEventsCollection/error/errorCollection.ts)]
...
### assembly [[code](https://github.com/openobserve/browser-sdk/blob/32ffe4bb7e50a37a43794773bbbc57aabb373468/packages/rum-core/src/domain/assembly.ts)]
...
### batch [[code](https://github.com/openobserve/browser-sdk/blob/32ffe4bb7e50a37a43794773bbbc57aabb373468/packages/core/src/transport/batch.ts)]
...
### httpRequest [[code](https://github.com/openobserve/browser-sdk/blob/32ffe4bb7e50a37a43794773bbbc57aabb373468/packages/core/src/transport/httpRequest.ts)]
