...
export const DEV_LOGS_URL = `${DEV_SERVER_ORIGIN}/openobserve-logs.js`
export const DEV_RUM_SLIM_URL = `${DEV_SERVER_ORIGIN}/openobserve-rum-slim.js`
export const DEV_RUM_URL = `${DEV_SERVER_ORIGIN}/openobserve-rum.js`
